...
public class PanelQuestionListController  implements UpdatableController {
	...
	private QuestionListDialog dialog;

	public PanelQuestionListController(QuestionListDialog dialog) {
